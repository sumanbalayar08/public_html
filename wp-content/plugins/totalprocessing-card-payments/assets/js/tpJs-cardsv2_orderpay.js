( function ( tp, $ ) {
    ...
    function fetchOrderTpCardsModalVersion(endpoint,checkoutData){
        ...
        fetch(endpoint , {
            ...
            oppwajs.setAttribute('src', 'https://' + tpCardVars.platformBase + '/v1/paymentWidgets.js?checkoutId=' + json.checkoutId);
            ...
            Swal.fire({
                ...
                imageHeight: 32,
                html: '<div id="cnpNav"></div><div id="cnpSwal"><form class="paymentWidgets" data-brands="' + tpCardVars.brands + '"></form></div>',
